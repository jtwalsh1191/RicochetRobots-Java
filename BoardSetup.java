...
public class BoardSetup extends JFrame implements ActionListener, MouseListener {
    ...
    private JButton savegame, exitgame, hint, checkchip, startclock, resetclock, pauseclock, up, down, left, right, resetrobotselection, bids, resetmove;
    ...
    public void mousePressed(MouseEvent me){
        ...
        if(click instanceof RobotPosition){
            xco = ((RobotPosition) click).returnrobotx();
            yco = ((RobotPosition) click).returnroboty();
